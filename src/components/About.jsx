    ...
    <section id="about" className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-gray-600 space-y-6">
          ...
          <p className="leading-relaxed">
            I believe in writing clean, maintainable code and creating intuitive user experiences. I'm always eager to learn new technologies and continuously improve my skills to deliver the best possible solutions.
          </p>
        </div>
      </div>
    </section>
